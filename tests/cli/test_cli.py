...
def test_run(run_patch, runner, run_settings, date, expected_exit_code, expected_exception):
    ...
    if actual_exit_code == 0:
        run_patch.assert_called_once_with(*run_settings, datetime.datetime(*map(int, date.split("-"))))
