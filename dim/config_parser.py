...
def main():
    ...
    # TODO: config parser should on deman read config specified via cli
    # TODO: only grab generate test objects for those specified in the cli command
    for config_path in get_all_paths_yaml(name,CONFIG_ROOT_PATH):
        ...
        for config in config["dim_config"]:
            for test in config["tests"]:
                ...
                # TODO: validation logic should be defined inside the test object
