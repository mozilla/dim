...
DIM_CHECK_CLASS_MAPPING = {
    ...
    "custom_sql_metric": getattr(custom_sql_metric, "CustomSqlMetric"),  # noqa: F405
    ...
    "numeric_values_matches": getattr(numeric_values_matches, "NumericValueMatches"),  # noqa: F405
    ...
    "custom_compare_metrics": getattr(custom_compare_metrics, "CustomCompareMetrics"),  # noqa: F405
}
...
RUN_HISTORY_TABLE = f"{DESTINATION_PROJECT}.{DESTINATION_DATASET}.{RUN_HISTORY_TABLE_NAME}"
...
MUTED_ALERTS_TABLE = f"{DESTINATION_PROJECT}.{DESTINATION_DATASET}.{MUTED_ALERTS_TABLE_NAME}"
